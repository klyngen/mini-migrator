...
`,
	FetchMigrationsQuery:       "SELECT id, name, status, hash FROM migrationTable",
	WriteMigrationQuery:        "INSERT INTO migrationTable  (id, timestamp, description, name, status, hash) VALUES($1, $2, $3, $4, $5, $6)",
	UpdateMigrationStatusQuery: "UPDATE migrationTable SET status = $1 WHERE id = $2",
}
